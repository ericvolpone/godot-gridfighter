...
const rock_scene: PackedScene = preload("res://entities/objects/combat/rock.tscn");
...
func execute_child() -> void:
	...
	print("ROCK READY on peer:", multiplayer.get_unique_id(), " | authority:", get_multiplayer_authority(), " | is_authority:", is_multiplayer_authority())
